...
function SuggestedBusinessList({ business }) {
    ...
    const getBusinessList = () => {
        const response = GlobalApi.getBusinessByCategory(business?.category?.name);
            ...
            <div className='hidden md:block'>
                ...
                <div className=''>
                    {businessList && businessList.map((business, index) => (
                        <Link key={index} href={'/details/' + business.id} className='flex gap-2 mb-4 hover:border rounded-lg p-2 cursor-pointer hover:shadow-md border-primary'>
